...
MENU_PROMPT = "Enter 'c' to create a blog, 'l' to list blogs, 'x' to read one, 'p' to create a post, or 'q' to quit: "
...
def ask_create_blog():
    title = input('Title of a blog: ')
    author = input('Author of a blog: ')
